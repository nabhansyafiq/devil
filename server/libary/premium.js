...
const premium = JSON.parse(fs.readFileSync('./server/system/premium.json'))
...
const addPremiumUser = (userId, expired, _dir) => {
	...
	fs.writeFileSync("./server/system/premium.json", JSON.stringify(_dir));
};
